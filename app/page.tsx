...
export default function PublicHome() {
  return (
    <main className="public-shell">
      <nav className="public-nav"><Link href="/">ANYWAY POSSIBLE</Link><div><a href="/api/health">STATUS</a><a href="#api">API</a></div></nav>
      ...
      <section className="api-panel" id="api">
        <div><p className="eyebrow">LIVE ENDPOINT</p><h2>POST /api/verify</h2><p>Send a public URL plus optional status or text expectations. An unpaid request returns the x402 payment requirements automatically.</p></div>
