  ...
  return (
    <main className="quiet-shell">
      ...
      <section className="quiet-discovery" aria-labelledby="discovery-title">
        <header><p className="quiet-label">WHERE AGENTS FIND US</p><h2 id="discovery-title">One service.<br />Three entrances.</h2><p>Agents do not need to belong to one marketplace or platform. Discovery works through Coinbase Bazaar, trusted MCP directories, and stable Direct HTTP contracts.</p></header>
        <div><article><span>01</span><h3>Coinbase Bazaar</h3><p>x402-native buyers discover eight paid endpoints by the decision they need and pay per call with USDC on Base.</p><footer><a href="https://api.cdp.coinbase.com/platform/v2/x402/discovery/merchant?payTo=0xe5690D37805107C56f6195E65A262b234E0E5e75">Verify Bazaar record ↗</a></footer></article><article><span>02</span><h3>MCP Registry</h3><p>Connect one remote server, ask the free recommender where to start, and discover eight paid decision tools automatically.</p><code>com.anywaypossible/<wbr />agent-utilities</code><footer><a href="https://registry.modelcontextprotocol.io/?q=com.anywaypossible%2Fagent-utilities">Official Registry ↗</a><a href="https://smithery.ai/servers/anyway-possible/agent-utilities">Smithery ↗</a><a href="https://glama.ai/mcp/connectors/com.anywaypossible/agent-utilities">Glama ↗</a></footer></article><article><span>03</span><h3>Direct HTTP</h3><p>Inspect exact requests and representative results before paying, then call any of eight stable routes.</p><footer><a href="/docs">Human docs ↗</a><a href="/catalog.json">Catalog ↗</a><a href="/openapi.json">OpenAPI ↗</a></footer></article></div>
      </section>

      <section className="quiet-api" id="api">
        <div><p className="quiet-label">CONNECT ONCE</p><h2>Give your agent<br />the whole toolkit.</h2><p>Add one remote MCP endpoint. The agent can call <code>recommend_tool</code> for free, see the right paid tool and exact price, then receive structured evidence—without an account or SDK.</p><div className="quiet-endpoint"><span>MCP ENDPOINT</span><code>https://anywaypossible.com/api/mcp</code></div><nav><a href="/docs">Integration guide ↗</a><a href="/examples">Result examples ↗</a><a href="/openapi.json">OpenAPI ↗</a><a href="/llms.txt">Agent instructions ↗</a></nav></div>
