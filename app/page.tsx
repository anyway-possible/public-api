  ...
  return (
    <main className="public-shell">
      ...
      <section className="api-panel" id="api">
        <div><p className="eyebrow">START FOR A TENTH OF A CENT</p><h2>POST /api/check</h2><p>Send a public URL plus an optional expected status. An unpaid request returns the x402 payment requirements automatically.</p><p><a href="/openapi.json">OpenAPI specification ↗</a> · <a href="/llms.txt">Agent instructions ↗</a></p></div>
        <pre><code>{`curl -X POST https://anywaypossible.com/api/check \\
