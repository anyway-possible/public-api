  ...
  return (
    <main className="quiet-shell">
      ...
      <section className="quiet-discovery" aria-labelledby="discovery-title">
        ...
        <div><article><span>01</span><h3>Coinbase Bazaar</h3><p>x402-native buyers discover all eight endpoints and pay per call with USDC on Base.</p><footer><a href="https://api.cdp.coinbase.com/platform/v2/x402/discovery/merchant?payTo=0xe5690D37805107C56f6195E65A262b234E0E5e75">Verify Bazaar record ↗</a></footer></article><article><span>02</span><h3>MCP Registry</h3><p>Connect one remote server and discover all eight decision tools automatically.</p><code>io.github.anyway-possible/agent-utilities</code><footer><a href="https://registry.modelcontextprotocol.io/?q=io.github.anyway-possible%2Fagent-utilities">Verify registry record ↗</a></footer></article><article><span>03</span><h3>Direct HTTP</h3><p>Inspect exact requests and results before paying, then call any of eight stable routes.</p><footer><a href="/docs">Human docs ↗</a><a href="/catalog.json">Catalog ↗</a><a href="/openapi.json">OpenAPI ↗</a></footer></article></div>
      </section>
